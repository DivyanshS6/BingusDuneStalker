package net.ImmenseJaguar.Bingus.block;
...
public class ModBlocks {
    public static final DeferredRegister.Blocks BLOCKS =
            DeferredRegister.createBlocks(Bingus.MODID);

    public static final DeferredBlock<Block> BINGUSTOOTH_BLOCK = registerBlock("bingustooth_block",
